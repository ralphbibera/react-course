...
function App() {
  return (
    <form className="d-flex flex-column border m-5 bg-body-tertiary rounded w-75 justify-content-center mx-auto">
      ...
      <button className="btn btn-primary w-50 mx-auto">Sign Up</button>
      <p className="mb-3 w-50 mx-auto text-end">Already registered? <a href="/">sign in?</a></p>
    </form>
  );
}
